...
class app(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        global img_list, image_files  , img_list1
        img_list, image_files,img_list1 = [], [] ,[]
    ...
    def image123(self):
        ...
        folder = r"D://notice//s3-backup//*.jpg"
        ...
        self.pictures = cycle((self.photo_image(image), image) for image in img_list1)
