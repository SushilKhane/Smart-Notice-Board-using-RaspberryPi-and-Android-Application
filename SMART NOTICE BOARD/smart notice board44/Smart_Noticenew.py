...
class Weather(Frame):
    ...
    def get_weather(self):
        ...
        self.after(60000000, self.get_weather)
        print('weather')
...
class News(Frame):
    ...
    def get_headlines(self):
        ...
        self.after(6000000, self.get_headlines)
        print('new')
...
class download(Frame):
    ...
    def downloading(self):
        ...
        for blob in blobs:
            folder = r"C:\Users\hp\Desktop\smart notice board44\storage\ " +blob.name
            ...
            self.after(60000, self.downloading)
         
    def image123(self):
        
        folder = r"C:\Users\hp\Desktop\smart notice board44\storage\*"
...
class FullscreenWindow:
    ...
    def __init__(self):
        ...
        self.download.pack(side=RIGHT ,anchor=N , padx=60, pady=60)
